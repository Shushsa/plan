...
> 注意：你的应用程序需要导入你刚编写的代码。这里导入路径设置为此仓库（github.com/Shushsa/plan/x/nameservice）。如果你是在自己项目中编写的，则需要更改导入路径成（github.com/{.Username}/ {.Project.Repo}/x/nameservice）。
...
import (
	...
	nameservicecmd "github.com/Shushsa/plan/x/nameservice/client/cli"
	"github.com/spf13/cobra"
